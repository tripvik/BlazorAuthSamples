...
builder.Services.AddAuthentication(MS_OIDC_SCHEME)
    .AddOpenIdConnect(MS_OIDC_SCHEME, oidcOptions =>
    {
        ...
        oidcOptions.Scope.Add($"api://{builder.Configuration["AzureAd:ClientId"]}/Weather.Get");
        // ........................................................................
...
// Forward the weather-forecast endpoint to the weatherapi service.
app.MapForwarder("/weather-forecast", "https://weatherapi", transformBuilder =>
{
    transformBuilder.AddRequestTransform(async transformContext =>
    {
        //Attach the user access token to the request
